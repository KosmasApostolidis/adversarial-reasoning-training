...
Usage:
    python scripts/train.py --config configs/training.yaml \
        ...
        --gold configs/gold.yaml --model qwen2_5_vl_7b
...
from adversarial_reasoning_training.gold.oracle import load_metadata_csv
...
from adversarial_reasoning_training.trainer.freeze import FreezeConfig, apply_freeze
...
def main() -> None:
    ...
    defense_cfg = _load_yaml(args.defenses)
    data_cfg = _load_yaml(args.data)
    gold_cfg = _load_yaml(args.gold)
    ft_cfg = _load_yaml(args.full_ft)
